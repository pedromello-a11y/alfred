...
async def inbound_from_gateway(
    ...
    try:
        response_text, classification = await alfred_brain_v2.process_message(text_body, db, origin="whatsapp")
        ...
        await db.commit()
        return {"status": "ok", "reply": response_text, "classification": classification}
