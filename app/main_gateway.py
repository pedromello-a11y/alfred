...
from app.routers import health, internal_whatsapp, webhook
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            ...
            if not plan_exists and hour_brt >= 9:
                logger.warning(
                    "Startup: daily_plan missing and it's past 09:00 BRT — running missed briefing."
                )
            ...
            if hour_brt >= 21:
                ...
                if plan and not plan.consolidated:
                    logger.warning(
                        "Startup: nightly closing not yet run today — running now."
                    )
