...
from app.cron.scheduler_rebuild import scheduler, setup_jobs
from app.database import init_db
from app.routers.dashboard_rebuild import router as dashboard_router
...
async def lifespan(app: FastAPI):
    logger.info("Alfred rebuild stack starting up...")
    await init_db()
    setup_jobs()
    scheduler.start()
    yield
